...
var _uploadBtn = /*#__PURE__*/new WeakMap();
...
var Uploader = /*#__PURE__*/function () {
  function Uploader(_selector) {
    ...
    _classPrivateFieldInitSpec(this, _uploadBtn, {
      writable: true,
      value: void 0
    });
    ...
    _classPrivateFieldInitSpec(this, _onUpload, {
      writable: true,
      value: void 0
    });

    _classPrivateFieldSet(this, _input, document.querySelector(_selector));

    _classPrivateFieldSet(this, _configs, configs);

    _classPrivateFieldSet(this, _onUpload, (_configs$onUpload = configs.onUpload) !== null && _configs$onUpload !== void 0 ? _configs$onUpload : noop);
  ...
  _createClass(Uploader, [{
    key: "openBtnCreater",
    value: function openBtnCreater(selector) {
      _classPrivateFieldSet(this, _openBtn, _classPrivateMethodGet(this, _elementCreator, _elementCreator2).call(this, "button", ["uploader-btn__open", "uploader-btn"], "Открыть"));
    ...
    value: function PreviewPrinter() {
      ...
      var imgsGroup = _classPrivateMethodGet(this, _elementCreator, _elementCreator2).call(this, "div", ["uploader-imgs"]);
      ...
      var changeHandler = function changeHandler(e) {
        ...
        if (!_classPrivateFieldGet(_this, _uploadBtn)) _classPrivateMethodGet(_this, _uploadBtnCreator, _uploadBtnCreator2).call(_this);
...
function _elementCreator2(selector, classList, inner) {
  var _elem$classList;

  var elem = document.createElement(selector);
  if (classList) (_elem$classList = elem.classList).add.apply(_elem$classList, _toConsumableArray(classList));
...
function _uploadBtnCreator2() {
  _classPrivateFieldSet(this, _uploadBtn, _classPrivateMethodGet(this, _elementCreator, _elementCreator2).call(this, "button", ["uploader-btn__upload", "uploader-btn"], "Загрузить"));

  _classPrivateFieldGet(this, _openBtn).after(_classPrivateFieldGet(this, _uploadBtn));

  _classPrivateMethodGet(this, _uploadClicker, _uploadClicker2).call(this);
}

function _removeBtnCreater2() {
  _classPrivateFieldSet(this, _removeBtn, _classPrivateMethodGet(this, _elementCreator, _elementCreator2).call(this, "button", ["uploader-btn__remove", "uploader-btn"], "Удалить"));

  _classPrivateFieldGet(this, _removeBtn).dataset.status = "inactive";

  _classPrivateFieldGet(this, _uploadBtn).after(_classPrivateFieldGet(this, _removeBtn));
  ...
  var removeHandler = function removeHandler() {
    ...
    if (_classPrivateFieldGet(_this3, _removeBtn).dataset.status === "inactive") {
      ...
      if (!_classPrivateFieldGet(_this3, _fileList).length) {
        ...
        _classPrivateFieldGet(_this3, _uploadBtn).remove();

        _classPrivateFieldSet(_this3, _uploadBtn, null);
...
function _uploadClicker2() {
  var _this4 = this;

  var uploadHandler = function uploadHandler() {
    _classPrivateFieldGet(_this4, _removeBtn).remove();

    _classPrivateFieldSet(_this4, _removeBtn, null);

    _classPrivateFieldGet(_this4, _uploadBtn).remove();

    _classPrivateFieldSet(_this4, _uploadBtn, null);

    var info = document.querySelectorAll(".uploader-imgs__item-info");
  ...
  onUpload: function onUpload(files, blocks) {
    ...
    files.forEach(function (file, i) {
      ...
      uploadTask.on("state_changed", function (snapshot) {
        ...
        var block = blocks[i].querySelector(".uploader-imgs__item-info__uploaded-progress");
